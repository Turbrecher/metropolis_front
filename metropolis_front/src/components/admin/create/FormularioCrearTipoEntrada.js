...
export function FormularioCrearTipoEntrada(props) {
    ...
    async function create() {
        ...
        await axios.post(
            "http://localhost:8000/compra/api/tiposentrada/",
            TipoEntrada,
            {
                headers: {
        ...
        <>
            ...
            <div className="admin">
                ...
                <div className="formulario_admin">
                    <h1 className="titulo">CREACIÓN DE TIPO DE ENTRADA</h1>
